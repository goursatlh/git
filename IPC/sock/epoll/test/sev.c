...
##args);
	   ...
	   pthread_create(s_tid + i, 0, (void *)test_server4,
	   ...
	   setsockopt(sock_listen4, SOL_SOCKET, SO_LINGER, &optval1,
		       sizeof(struct linger));
	    if (0 >
		  bind(sock_listen4, (struct sockaddr *)&addr4, sizeof(addr4)))
	   {
	   ...
	   sprintf(p, "<p>线程池总数 %d 活动线程总数 %d</p>\r\n", THREAD_MAX,
